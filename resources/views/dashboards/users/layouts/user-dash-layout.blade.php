...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ \URL::to('/')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">AAS Drive</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      Founder by <a href="http://mochamadhaikal.github.io/portfolio" target="_blank">KaLe.</a>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="https://aaslaboratory.com" target="_blank">AAS Labolatory</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
