                    ...
                    <div class="card-body">
                        ...
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="{{ url('admin/delete-file/'.$file->id) }}">
                                    <i class="fas fa-trash"></i> Delete
                                </a>
                                <a class="dropdown-item" href="{{ url('admin/download/'.$file->id) }}" target="_blank">
    ...
    <div class="modal fade" id="newFolderModal" tabindex="-1" role="dialog" aria-labelledby="newFolderModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('createFolder') }}" method="post" id="new-folder">
                    @csrf
